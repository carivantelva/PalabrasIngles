...
var verbs = [
    //verbos grupo 1
      ...
      { english: "Look like", spanish: "Parecerse a" },
      { english: "Put", spanish: "Poner colocar" },
      { english: "Report", spanish: "Reportar Reporte" },
      { english: "Ride", spanish: "Montar Dar un paseo" },
      ...
      { english: "Work", spanish: "Trabajar Trabajo " },
    //Verb grupo 3
      ...
      { english: "Agree with", spanish: "Estar de acuerdo con" },
      { english: "Disagree", spanish: "No estar de acuerdo" },
      { english: "Disagree with", spanish: "No estar de acuerdo con" },
      ...
      { english: "Cool down", spanish: "Enfriar" },
       ...
       { english: "Cage", spanish: "Jaula Enjaular" },
       { english: "Cow", spanish: "Vaca" },
       { english: "Cat", spanish: "Gato" },
       { english: "Dog", spanish: "Perro" },
       { english: "Bird", spanish: "Pajaro" },
       { english: "Donkey", spanish: "Burro" },
       { english: "Eagle", spanish: "Aguila" },
       { english: "Elephant", spanish: "Elefante" },
       { english: "Hawk", spanish: "Halcon" },
       { english: "Horse", spanish: "Caballo" },
       { english: "Lion", spanish: "Leon" },
       { english: "Mouse", spanish: "Raton" },
       { english: "mice", spanish: "Ratones" },
       { english: "Meat", spanish: "Carne" },
       { english: "Monkey", spanish: "Mico" },
       { english: "Parrot", spanish: "Loro" },
       { english: "Panther", spanish: "Pantera" },
       { english: "Rhino", spanish: "Rinoceronte" },
       { english: "Zoo", spanish: "Zoologico" },
       { english: "Tamer", spanish: "Domador" },
       { english: "Rat", spanish: "Rata" },
       
       //Verbos grupo 6
       { english: "Appreciate", spanish: "Apreciar" },
       { english: "Fish", spanish: "Pescar Pescado" },
       { english: "Fire", spanish: "Echar del trabajo Incendiar Fuego" },
       { english: "Fly", spanish: "Volar Mosca" },
       { english: "Hire", spanish: "Emplear Contratar" },
       { english: "Inform", spanish: "Informar" },
       { english: "Improve", spanish: "Mejorar" },
       { english: "Introduce", spanish: "Presentar Introducir" },
       { english: "Invent", spanish: "Inventar" },
       { english: "Itch", spanish: "Picar Picazon" },
       { english: "Interrupt", spanish: "Interrumpir" },
       { english: "Joke", spanish: "Bromear Broma" },
       { english: "Line", spanish: "Alinear Linea" },
       { english: "Mix", spanish: "Mezclar Mezcla" },
       { english: "Offer", spanish: "Ofrecer Oferta" },
       { english: "Park", spanish: "Parquear Parque" },
       { english: "Play", spanish: "Jugar Juego" },
       { english: "Talk", spanish: "Hablar" },
       { english: "Talk to", spanish: "Hablar con" },
       { english: "Regret", spanish: "Arrepentirse" },
       { english: "Expect", spanish: "Esperar" },
       { english: "Try", spanish: "Tratar" },
       { english: "Want", spanish: "Querer Desear" },
       { english: "Wish", spanish: "Desear Deseo" },
       { english: "Like", spanish: "Gustar, como, Semejante" },
       //
       //Verbos grupo 7
       { english: "Dream", spanish: "Soñar Sueño" },
       { english: "Dream To", spanish: "Soñar Sueño con" },
       { english: "Dream about", spanish: "Soñar Sueño con" },
       { english: "Go to bed", spanish: "Acostarse" },
       { english: "Plan", spanish: "Planear Plan" },
       { english: "read", spanish: "Leer" },
       { english: "Sleep", spanish: "Dormir" },
       { english: "Stop", spanish: "Parar Parada" },
       { english: "Stay", spanish: "Quedarse Permanencia" },
       { english: "Stay alive", spanish: "Sobrevivir" },
       { english: "Swim", spanish: "Nadar" },
       { english: "Thank", spanish: "Agradecer Gracias" },
       { english: "Start", spanish: "Empezar Arranque" },
       { english: "Wash", spanish: "Lavar" },
       { english: "Watch", spanish: "Mirar Reloj" },
       { english: "Wake up", spanish: "Despertar" },
       { english: "Need", spanish: "Necesitar" },
       { english: "Hope", spanish: "Esperar Esperanza" },
       { english: "Wait", spanish: "Esperar" },
       { english: "Wait for", spanish: "Esperar a" },
       { english: "Have", spanish: "Tener" },
       { english: "Have to", spanish: "Tener que" },

       //Vocabulario 3

       { english: "All", spanish: "Todo" },
       { english: "Bank", spanish: "Banco" },
       { english: "Banker", spanish: "Banquero" },
       { english: "Blood", spanish: "Sangre" },
       { english: "Building", spanish: "Edificio" },
       { english: "Bed", spanish: "Cama" },
       { english: "Cop", spanish: "Policia" },
       { english: "City", spanish: "Ciudad" },
       { english: "Down town", spanish: "Centro de la ciudad" },
       { english: "Here", spanish: "Aqui" },
       { english: "Town", spanish: "Pueblo" },
       { english: "Police officer", spanish: "Policia" },
       { english: "This", spanish: "Este" },
       { english: "These", spanish: "Estas" },
       { english: "That", spanish: "Ese" },
       { english: "Those", spanish: "Esos" },
       { english: "There", spanish: "Alli" },
       { english: "Over there", spanish: "Alla" },
       { english: "Test", spanish: "Examen" },
       { english: "Together", spanish: "Juntos" },
       { english: "Thief", spanish: "Ladron" },
       { english: "Village", spanish: "Pueblito Aldea" },
       { english: "Popsicle", spanish: "Paleta" },
       { english: "Ice cream", spanish: "Helado" },
       { english: "Candy", spanish: "Caramelo Golosina" },
       { english: "Chocolate bar", spanish: " Barra de chocolate" },
       { english: "Flavor", spanish: "Sabor" },
       { english: "Jello", spanish: "Gelatina" },
       { english: "Jelly", spanish: "Jalea Gelatina" },
       { english: "Dairy", spanish: "Lecheria" },
       { english: "Dairy case", spanish: "Seccion de productos lacteos" },
       { english: "Tasty", spanish: "" },


       // 7 verbos 3 caso to, not to

       { english: "Advise", spanish: "Aconsejar" },
       { english: "Ask", spanish: "Pedir" },
       { english: "Insist", spanish: "Insistir" },
       { english: "Order", spanish: "Ordenar" },
       { english: "Recomend", spanish: "Recomendar" },
